...
import com.example.android_level_3.presentation.ui.adapter.ElementClickListener
...
class FragmentAddContact : Fragment(), ElementClickListener {
    ...
    private fun setObservers() {
        ...
        viewModel.isActiveSearchAddContact.observe(viewLifecycleOwner) { visible ->
            with(binding) {
                if (visible) {
                    toolbarAddContact.containerTextAddContact.gone()
                    toolbarAddContact.containerSearchAddContact.visible()
                } else {
                    toolbarAddContact.containerTextAddContact.visible()
                    toolbarAddContact.containerSearchAddContact.gone()
